...
must_haves:
  ...
  key_links:
    ...
    - from: "Packages/com.google.ai-embodiment/Runtime/PersonaSession.cs"
      to: "Packages/com.google.ai-embodiment/Runtime/SystemInstructionBuilder.cs"
      via: "SystemInstructionBuilder.Build(_config) call in Connect()"
      pattern: "SystemInstructionBuilder\\.Build"
    - from: "Packages/com.google.ai-embodiment/Runtime/PersonaSession.cs"
      to: "Packages/com.google.ai-embodiment/Runtime/MainThreadDispatcher.cs"
    ...
    - from: "Packages/com.google.ai-embodiment/Runtime/PersonaSession.cs"
      to: "Packages/com.google.ai-embodiment/Runtime/SessionState.cs"
...
<task type="auto">
  ...
  <action>
    **PersonaSession.cs** -- Create in `Packages/com.google.ai-embodiment/Runtime/`:
  ...
  <verify>
    1. Verify file exists: `ls Packages/com.google.ai-embodiment/Runtime/PersonaSession.cs`
