...
must_haves:
  ...
  artifacts:
    ...
    - path: "Packages/com.google.ai-embodiment/Runtime/SystemInstructionBuilder.cs"
      ...
      min_lines: 20
  key_links:
    - from: "Packages/com.google.ai-embodiment/Runtime/SystemInstructionBuilder.cs"
      to: "Packages/com.google.ai-embodiment/Runtime/PersonaConfig.cs"
    ...
    - from: "Packages/com.google.ai-embodiment/Runtime/PersonaConfig.cs"
      to: "Packages/com.google.ai-embodiment/Runtime/VoiceBackend.cs"
...
<task type="auto">
  ...
  <action>
    **VoiceBackend.cs** -- Create in `Packages/com.google.ai-embodiment/Runtime/`:
    ...
    **PersonaConfig.cs** -- Create in `Packages/com.google.ai-embodiment/Runtime/`:
  ...
  <verify>
    1. Verify files exist: `ls Packages/com.google.ai-embodiment/Runtime/PersonaConfig.cs Packages/com.google.ai-embodiment/Runtime/VoiceBackend.cs`
...
<task type="auto">
  ...
  <action>
    **SystemInstructionBuilder.cs** -- Create in `Packages/com.google.ai-embodiment/Runtime/`:
  ...
  <verify>
    1. Verify file exists: `ls Packages/com.google.ai-embodiment/Runtime/SystemInstructionBuilder.cs`
