...
must_haves:
  ...
  artifacts:
    ...
    - path: "Packages/com.luke42studios.ai-embodiment/package.json"
      provides: "UPM package manifest"
      contains: "com.luke42studios.ai-embodiment"
    - path: "Packages/com.luke42studios.ai-embodiment/Runtime/com.luke42studios.ai-embodiment.asmdef"
      provides: "Runtime assembly definition referencing Firebase.AI"
      contains: "Firebase.AI"
    - path: "Packages/com.luke42studios.ai-embodiment/Runtime/MainThreadDispatcher.cs"
      provides: "Thread-safe main thread dispatch via ConcurrentQueue"
      min_lines: 30
    - path: "Packages/com.luke42studios.ai-embodiment/Runtime/SessionState.cs"
      provides: "Session lifecycle state enum"
      contains: "enum SessionState"
  key_links:
    - from: "Packages/com.luke42studios.ai-embodiment/Runtime/com.luke42studios.ai-embodiment.asmdef"
      to: "Assets/Firebase/FirebaseAI/Firebase.AI.asmdef"
      via: "assembly reference in references array"
      pattern: "Firebase\\.AI"
    - from: "Packages/com.luke42studios.ai-embodiment/Runtime/MainThreadDispatcher.cs"
...
<task type="auto">
  ...
  <action>
    ...
    **Step 2: Create UPM package directory structure.**
    ...
    Create the following directory tree under `Packages/com.luke42studios.ai-embodiment/`:
    ```
    Packages/com.luke42studios.ai-embodiment/
      package.json
      CHANGELOG.md
      LICENSE.md
      Runtime/
    ...
    **Step 5: Create Editor asmdef.**
    ...
    ```json
    {
        "name": "com.luke42studios.ai-embodiment.editor",
    ...
    **Step 6: Create Tests/Runtime asmdef.**
    ...
    ```json
    {
        "name": "com.luke42studios.ai-embodiment.tests",
    ...
    **Step 7: Create CHANGELOG.md and LICENSE.md.**
    ...
    LICENSE.md: MIT license with "Luke42 Studios" and current year.
  </action>
  <verify>
    1. Verify all files exist: `ls -R Packages/com.luke42studios.ai-embodiment/` and `ls Assets/Firebase/FirebaseAI/Firebase.AI.asmdef`
    2. Validate JSON syntax: `python3 -c "import json; json.load(open('Packages/com.luke42studios.ai-embodiment/package.json'))"` (repeat for each .asmdef)
  ...
  <done>
    ...
    - UPM package directory tree exists under Packages/com.luke42studios.ai-embodiment/
...
<task type="auto">
  ...
  <action>
    **MainThreadDispatcher.cs** -- Create in `Packages/com.luke42studios.ai-embodiment/Runtime/`:
    ...
    **SessionState.cs** -- Create in `Packages/com.luke42studios.ai-embodiment/Runtime/`:
  ...
  <verify>
    1. Verify files exist: `ls Packages/com.luke42studios.ai-embodiment/Runtime/MainThreadDispatcher.cs Packages/com.luke42studios.ai-embodiment/Runtime/SessionState.cs`
...
<success_criteria>
- UPM package structure exists under Packages/com.luke42studios.ai-embodiment/ with all required directories and files
